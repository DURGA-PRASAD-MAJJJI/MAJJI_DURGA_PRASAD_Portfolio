  ...
  const projects = [
    {
      ...
      title: "Medication",
      description:
        "A full-stack MERN app for doctor appointment scheduling, featuring admin and patient dashboards.",
      image: "/src/assets/medication.jpg",
      technologies: ["MongoDB", "Express.js", "React.js", "Node.js"],
      category: "fullstack",
      live: "https://medication-frontend-ms9b.onrender.com/",
    },
    {
      id: 2,
      title: "Sculpt",
      description:
        "A LangChain-powered AI video assistant with video summarization, webpage integration, and context-aware Q&A.",
      image:
        "/src/assets/sculpt.jpg",
      technologies: ["LangChain", "React", "Node.js", "AI APIs"],
      category: "frontend",
      github: "#",
      live: "#",
    },
    {
      ...
      title: "Events Buddy",
      description:
        "An event discovery platform using HTML, CSS, JS, and Firebase for real-time event tracking.",
      image:
        "/src/assets/events buddy.jpg",
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <div className="flex gap-4">
                      <motion.a
                        ...
                        whileTap={{ scale: 0.9 }}
                        href={project.github}
                        className="p-3 bg-slate-900/80 rounded-full text-white hover:bg-slate-800 transition-colors"
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 text-xs bg-slate-700/50 text-gray-300 rounded-full border border-slate-600"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        {filteredProjects.length > 6 && (
          <div className="flex justify-center mt-12">
            <motion.button
              ...
              className="px-6 py-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold shadow-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-300"
            >
